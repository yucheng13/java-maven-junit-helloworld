node {
   ...
   stage('Preparation') { // for display purposes
      ...
      properties([[$class: 'GitLabConnectionProperty', gitLabConnection: ''], [$class: 'RebuildSettings', autoRebuild: false, rebuildDisabled: false], pipelineTriggers([[$class: 'GitHubPRTrigger', events: [[$class: 'GitHubPROpenEvent']], spec: 'H * * * *', triggerMode: 'CRON'], [$class: 'GitHubPushTrigger']])])     
      // Get the Maven tool.
